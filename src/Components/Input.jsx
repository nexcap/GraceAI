...
import Modelparams from "../WakeWord/p";

import VoiceWidget from "../WakeWord";
...
//   }
//   const porcupineModel = { publicPath: Modelparams }
...
function GenVoice(Text_for_voice){
  ...
  const options = {
    ...
    headers: {
      ...
      Authorization: 'Bearer 1ogg6aW9tYoNJnt4oCh424yfzDg0EcVyN0wCCNE34RtUOZLJCvuIiv'
    },
    data: {
      Text: Text_for_voice,
      VoiceId: 'Liv',
  ...
  .then(function (response) {
    console.log(response.data.OutputUri);
    VoiceUrl = response.data.OutputUri;
